<template>
    <div>
        ...
        <div class="message-answer" v-for="element in this.mainJSON.task2.radio2Options"
...
<script>
    ...
    export default {
        ...
        methods: {
            save(el) {
                this.mainJSON.task2.results.ULHLDT3_Log_HLK3_2 = el.name
