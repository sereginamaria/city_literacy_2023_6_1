        ...
        <div class="d-flex justify-content-center align-items-center w-100"
            ...
            <div class="background-task flex-row flex-wrap" style="height: 85%; padding: 0">
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(1)" src="../../assets/TaskVolunteersElectronicServices6.webp" alt="" :class="{choose: mainJSON.taskVolunteers.results.ULSE1_Log2_SEK5_1 === 1}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(2)" src="../../assets/TaskVolunteersElectronicServices5.webp" alt="" :class="{choose: mainJSON.taskVolunteers.results.ULSE1_Log2_SEK5_1 === 2}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(3)" src="../../assets/TaskVolunteersElectronicServices3.webp" alt="" :class="{choose: mainJSON.taskVolunteers.results.ULSE1_Log2_SEK5_1 === 3}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(4)" src="../../assets/TaskVolunteersElectronicServices4.webp" alt="" :class="{choose: mainJSON.taskVolunteers.results.ULSE1_Log2_SEK5_1 === 4}">
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            checkAnswer() {
                ...
                if(this.mainJSON.taskVolunteers.results.ULSE1_Log2_SEK5_1 === 1){
                    this.mainJSON.taskVolunteers.results.ULSE1_Score2_SEK5_1 = 1
                }
                else this.mainJSON.taskVolunteers.results.ULSE1_Score2_SEK5_1 = 0
                let t = new Date()
