<template>
    <div class="background d-flex align-items-center flex-column" style="backdrop-filter: blur(5px);"
        ...
        <div class="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.task3.results.ULSE1_Log_SES1_1 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.task3.results.ULSE1_Log_SES1_1 = el.id
            },
            checkAnswer() {
                screen.isShow = false
