    ...
    <div class="background d-flex align-items-center flex-column" style="backdrop-filter: blur(5px);"
        ...
        <div class="d-flex justify-content-center align-items-center w-100 h-100">
            <div class="option-answers-background">
                <div v-for="el in constTaskVolunteers.listOfAnswersOverturnedTrashBin" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskVolunteers.results.ULSE1_Log_SES4}"
        ...
        <div class="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskVolunteers.results.ULSE1_Log_SES4 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskVolunteers.results.ULSE1_Log_SES4 = el.id
            },
            checkAnswer() {
                screen.isShow = false
                ...
                if (this.mainJSON.taskVolunteers.results.ULSE1_Log_SES4 === 2){
                    this.mainJSON.taskVolunteers.results.ULSE1_Score_SES4 = 1
                }
                else this.mainJSON.taskVolunteers.results.ULSE1_Score_SES4 = 0
                let t = new Date()
