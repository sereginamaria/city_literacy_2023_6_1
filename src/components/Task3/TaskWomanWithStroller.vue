<template>
    <div class="background d-flex align-items-center flex-column" style="backdrop-filter: blur(5px);"
        ...
        <div class="background-text" id="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskVolunteers.results.ULSE1_Log_SES5 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskVolunteers.results.ULSE1_Log_SES5 = el.id
            },
            checkAnswer() {
                screen.isShow = false
                ...
                if (this.mainJSON.taskVolunteers.results.ULSE1_Log_SES5 === 1){
                    this.mainJSON.taskVolunteers.results.ULSE1_Score_SES5 = 1
                }
                else this.mainJSON.taskVolunteers.results.ULSE1_Score_SES5 = 0
                let t = new Date()
