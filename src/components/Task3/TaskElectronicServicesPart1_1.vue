<template>
    <div class="background d-flex align-items-center flex-column" style="backdrop-filter: blur(5px);"
        ...
        <div class="d-flex justify-content-center align-items-center w-100 h-100">
            <div class="background-task flex-row flex-wrap" style="height: 85%; padding: 0">
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(1)" src="../../assets/TaskVolunteersElectronicServices1.png" alt="" :class="{choose: mainJSON.task3.results.ULSE1_Log1_SEK5_1 === 1}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(2)" src="../../assets/TaskVolunteersElectronicServices2.png" alt="" :class="{choose: mainJSON.task3.results.ULSE1_Log1_SEK5_1 === 2}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(3)" src="../../assets/TaskVolunteersElectronicServices3.png" alt="" :class="{choose: mainJSON.task3.results.ULSE1_Log1_SEK5_1 === 3}">
                </div>
                <div class="electronic_services_part1_img_block">
                    <img @click="choose(4)" src="../../assets/TaskVolunteersElectronicServices4.png" alt="" :class="{choose: mainJSON.task3.results.ULSE1_Log1_SEK5_1 === 4}">
                </div>
            </div>
        </div>
        ...
        <div class="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.task3.results.ULSE1_Log1_SEK5_1 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            choose(id) {
                this.mainJSON.task3.results.ULSE1_Log1_SEK5_1 = id
            },
            checkAnswer() {
                screen.isShow = false
