    ...
    <div class="background d-flex align-items-center flex-column" style="backdrop-filter: blur(5px);"
        ...
        <div class="d-flex justify-content-center align-items-center w-100 h-100">
            <div class="option-answers-background">
                <div v-for="el in constTaskVolunteers.listOfAnswersWaxwing" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.task3.results.ULSE1_Log_SES1}"
        ...
        <div class="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.task3.results.ULSE1_Log_SES1 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.task3.results.ULSE1_Log_SES1 = el.id
            },
            checkAnswer() {
                screen.isShow = false
