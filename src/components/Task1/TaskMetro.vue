<template>
    ...
    <div class="background" :style="{ background: 'url(' + require('../../assets/' + screen.imgURL + '.png') + ')'}">
        ...
        <div class="option-answers-background">
            <div v-for="el in constTaskNightInTheMuseum.listOfAnswersTaskMetro" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskNightInTheMuseum.results.ULSCLL1_Log_SCK2_1}"
        ...
        <div class="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskNightInTheMuseum.results.ULSCLL1_Log_SCK2_1 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskNightInTheMuseum.results.ULSCLL1_Log_SCK2_1 = el.id
            },
            checkAnswer(){
                screen.isShow = false
                ...
                if(this.mainJSON.taskNightInTheMuseum.results.ULSCLL1_Log_SCK2_1 === 3){
                    this.mainJSON.taskNightInTheMuseum.results.ULSCLL1_Score_SCK2_1 = 1
                }
                else {
                    this.mainJSON.taskNightInTheMuseum.results.ULSCLL1_Score_SCK2_1 = 0
                }
                let t = new Date()
